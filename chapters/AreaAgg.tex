...
In this way, we can guarantee that our final result
...
the greedy algorithm computes the costs of 
aggregating the smallest patch 
with each of the neighbors
and then selects the aggregation that costs least.
...
type distances~$d(5112,4102)=4$ and~$d(2112,4102)=6$.

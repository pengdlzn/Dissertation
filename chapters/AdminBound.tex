\chapter
%[Generalizing Administrative Boundaries]
{Generalizing Administrative Boundaries	\\
	Based on Compatible Triangulations}
\label{chap:Admin}


Nowadays people often browse through digital maps on computers or
small displays to get geographic information. To understand maps
better, users interactively zoom in and out to read maps from
different levels. A typical strategy to support zooming is based on a
...
Let~$\alpha(0)=(x_1,y_1)$, $\alpha(1)=(x_2,y_2)$, $\beta(0)=(x_3,y_3)$, and~$\beta(1)=(x_4,y_4)$, 
...
Let~$X=au^2+bu+c$. 
We have~$a\geq0$ and, 
since~$X\geq0$ ($X$ is the square of a Euclidean distance), $\Delta=4ac-b^2\geq0$. 

...
%[Choosing the Right Data Strucures]
{Choosing the Right Data Strucures\\
...
\begin{figure}[tb]
	...
	\caption{
		An instance of the DT.
		The line segments between the points are the edges of 
		the DT.
		The side length of the square is $2\varepsilon	
		=0.006$; 
...
We also observe that in both experiments the time it took to 
only 
